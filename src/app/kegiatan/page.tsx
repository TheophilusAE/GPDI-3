...
import { Calendar, Clock, MapPin, Users, Heart, BookOpen, Music, Globe } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Bergabunglah dalam berbagai kegiatan yang kami adakan untuk membangun iman dan 
              memperkuat persekutuan dalam komunitas kami.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Berbagai jenis kegiatan yang kami selenggarakan sepanjang tahun
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {upcomingEvents.map((event, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
